...
class BarcodeDisplay extends HTMLElement {
  settings = null
  #camera
   ...
   * Constructor
   *
   * @param {BarcodeReader} barcodeReader - Barcode readerclass
   * @param {Object|undefined} [options] - Options
   */
  constructor (barcodeReader, options) {
    super()
